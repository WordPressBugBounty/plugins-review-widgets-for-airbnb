...
$trustindex_pm_airbnb = new TrustindexPlugin_airbnb("airbnb", __FILE__, "13.2.7", "Widgets for Airbnb Reviews", "Airbnb");
...
require_once(__DIR__ . '/include/elementor-widgets.php');
$widgetsManager->register(new \Elementor\TrustrindexElementorWidget_Airbnb([], [$pluginManagerInstance]));
}
});
...
require_once(__DIR__ . '/include/elementor-widgets.php');
$widgetsManager->register_widget_type(new \Elementor\TrustrindexElementorWidget_Airbnb([], [$pluginManagerInstance]));
}
});
...
echo wp_kses_post(sprintf(__('Download our new <a href="%1$s" target="_blank">%2$s</a> plugin and get features for free!', 'review-widgets-for-airbnb'), 'https://wordpress.org/plugins/customer-reviews-collector-for-woocommerce/', 'Customer Reviews Collector for WooCommerce'));
?></strong></p>
<ul style="list-style-type: disc; margin-left: 10px; padding-left: 15px">
<li><?php echo esc_html(__('Send unlimited review invitations for free', 'review-widgets-for-airbnb')); ?></li>
<li><?php echo esc_html(__('E-mail templates are fully customizable', 'review-widgets-for-airbnb')); ?></li>
<li><?php echo esc_html(__('Collect reviews on 100+ review platforms (Google, Facebook, Yelp, etc.)', 'review-widgets-for-airbnb')); ?></li>
</ul>
<p>
<a href="<?php echo esc_url(wp_nonce_url(admin_url("admin.php?page=review-widgets-for-airbnb/settings.php&wc_notification=open"), 'ti-wc-notification')); ?>" target="_blank" class="ti-close-notification" style="text-decoration: none">
<button class="button button-primary"><?php echo esc_html(__('Download plugin', 'review-widgets-for-airbnb')); ?></button>
</a>
<a href="<?php echo esc_url(wp_nonce_url(admin_url("admin.php?page=review-widgets-for-airbnb/settings.php&wc_notification=hide"), 'ti-wc-notification')); ?>"target="_blank" class="ti-hide-notification" style="text-decoration: none">
<button class="button button-secondary"><?php echo esc_html(__('Do not remind me again', 'review-widgets-for-airbnb')); ?></button>
</a>
</p>
</div>
<?php
...
echo esc_html($ourToken);
}
catch(Exception $e) {
echo wp_kses_post('Error in WP: '. $e->getMessage());
}
exit;
});
...
<button class="button ti-button-primary button-primary">'. esc_html(__('Write a review', 'review-widgets-for-airbnb')) .'</button>
</a>
...
'. esc_html(__('Maybe later', 'review-widgets-for-airbnb')) .'
</a>
...
'. esc_html(__('Do not remind me again', 'review-widgets-for-airbnb')) .'
</a>
';
}
else {
...
'. esc_html(__('Remind me later', 'review-widgets-for-airbnb')) .'
</a>';
}
}
echo '
