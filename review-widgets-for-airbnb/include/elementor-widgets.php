<?php
namespace Elementor;
use TrustindexPlugin_Airbnb;
use Elementor\Widget_Base;
defined('ABSPATH') or die('No script kiddies please!');
class TrustrindexElementorWidget_Airbnb extends Widget_Base {
private $pluginManagerInstance;
private $shortName = 'airbnb';
private $platformName = 'Airbnb';
...
return $this->platformName .' '. __('Reviews', 'review-widgets-for-airbnb') . ' - Trustindex';
}
...
{
$this->start_controls_section('content_section', [ 'label' => __('Widget type', 'review-widgets-for-airbnb') ]);
...
'title' => '',
'icon' => '',
'label' => ucfirst(__('free', 'review-widgets-for-airbnb')) . ' widget',
],
'pro' => [
'title' => '',
'icon' => '',
...
'notice_type' => 'success',
'heading' => __('UPGRADE to PRO Features', 'review-widgets-for-airbnb'),
/* translators: %d: number */
'content' => sprintf(__('Automatic review update, creating unlimited review widgets, downloading and displaying all reviews, %d review platforms available!', 'review-widgets-for-airbnb'), 137)
. '<br /><br /><a href="https://www.trustindex.io/?a=sys&c=wp-google-elementor" target="_blank">'.__('Create a Free Account for More Features', 'review-widgets-for-airbnb').'</a>',
'condition' => [ 'type' => 'free' ],
]);
}
...
'placeholder' => sprintf(__('Paste the widget shortcode from the Advanced Widget Editor on the %s.', 'review-widgets-for-airbnb'), 'admin.trusintdex.io'),
'label_block' => true,
'condition' => [ 'type' => 'pro' ],
]);
