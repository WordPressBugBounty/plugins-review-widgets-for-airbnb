...
$stepList = [
/* translators: %s: Airbnb */
sprintf(__('Connect %s', 'review-widgets-for-airbnb'), 'Airbnb'),
__('Select Layout', 'review-widgets-for-airbnb'),
__('Select Style', 'review-widgets-for-airbnb'),
__('Set up widget', 'review-widgets-for-airbnb'),
__('Insert code', 'review-widgets-for-airbnb')
];
$stepDone = 0;
...
<p>
<?php
$advancedTab = '<a href="?page='.esc_attr($_page).'&tab=advanced#trustindex-admin">'.__('Advanced', 'review-widgets-for-airbnb').'</a>';
/* translators: %s: Advanced tab link */
echo wp_kses_post(sprintf(__("You have connected your Trustindex account, so you can find premium functionality under the %s tab. You no longer need this tab unless you choose the limited but forever free mode.", 'review-widgets-for-airbnb'), $advancedTab));
?>
</p>
</div>
<?php endif; ?>
...
<p>
<?php echo wp_kses_post(__('While downloading the reviews, we noticed that your connected page is not found.<br />If it really exists, please contact us to resolve the issue or try connect it again.', 'review-widgets-for-airbnb')); ?><br />
</p>
</div>
<?php elseif ($isReviewDownloadInProgress): ?>
<div class="ti-notice ti-notice-warning">
<p>
<?php echo esc_html(__('Your reviews are being downloaded.', 'review-widgets-for-airbnb')) . ' ' . esc_html(__('This process should only take a few minutes.', 'review-widgets-for-airbnb')); ?>
<br />
<?php echo esc_html(__('While you wait, you can start the widget setup with some review templates.', 'review-widgets-for-airbnb')); ?>
<?php if ($pluginManagerInstance->is_review_manual_download()): ?>
<br />
<a href="#" id="ti-review-manual-download" data-nonce="<?php echo esc_attr(wp_create_nonce('ti-download-reviews')); ?>" class="ti-btn ti-btn-sm ti-tooltip ti-toggle-tooltip" style="margin-top: 5px">
<?php echo esc_html(__('Manual download', 'review-widgets-for-airbnb')); ?>
...
<p>
<?php echo esc_html(__('Free plugin features are unavailable with AMP plugin.', 'review-widgets-for-airbnb')); ?>
<?php if ($pluginManagerInstance->is_trustindex_connected()): ?>
 <a href="?page=<?php echo esc_attr($_page); ?>&tab=advanced">Trustindex admin</a>
<?php else: ?>
 <a href="https://www.trustindex.io/?a=sys&c=wp-amp" target="_blank"><?php echo esc_html(__('Try premium features (like AMP) for free', 'review-widgets-for-airbnb')); ?></a>
<?php endif; ?>
</p>
...
/* translators: %s: Airbnb */
echo esc_html(sprintf(__('Connect %s', 'review-widgets-for-airbnb'), 'Airbnb'));
?></h1>
...
<a href="<?php echo esc_url(wp_nonce_url('?page='. esc_attr($_page) .'&tab=free-widget-configurator&command=delete-page', 'ti-delete-page')); ?>" class="ti-btn ti-btn-primary ti-btn-loading-on-click"><?php echo esc_html(__('Disconnect', 'review-widgets-for-airbnb')); ?></a>
</div>
<?php else: ?>
<div class="ti-box">
...
<p><?php echo esc_html(__("A popup window should be appear! Please, go to there and continue the steps! (If there is no popup window, you can check the the browser's popup blocker)", 'review-widgets-for-airbnb')); ?></p>
</div>
...
/* translators: %s: Airbnb */
$labelText = sprintf(__('%s Business URL', 'review-widgets-for-airbnb'), 'Airbnb');
$infoText = __("Type your business/company's URL and select from the list", 'review-widgets-for-airbnb');
/* translators: %s: Airbnb */
$errorText = sprintf(__('Please add your URL again: this is not a valid %s page.', 'review-widgets-for-airbnb'), "Airbnb");
$placeholder = __('e.g.:', 'review-widgets-for-airbnb') . ' ' . esc_attr($exampleUrl);
...
<p><?php echo wp_kses_post($errorText); ?></p>
</div>
<div class="ti-connect-platform">
<div class="ti-connect-platform-inner">
<label><?php echo wp_kses_post($labelText); ?>:</label>
<input class="ti-form-control" placeholder="<?php echo esc_attr($placeholder); ?>" type="text" />
<a href="#" class="ti-btn"><?php echo esc_html(__('Check', 'review-widgets-for-airbnb')); ?></a>
</div>
<span class="ti-info-text"><?php echo wp_kses_post($infoText); ?></span>
</div>
<div class="ti-source-box ti-d-none">
<img />
<div class="ti-source-info"></div>
<a href="#" class="ti-btn btn-connect"><?php echo esc_html(__('Connect', 'review-widgets-for-airbnb')); ?></a>
</div>
</form>
</div>
<?php endif; ?>
<h1 class="ti-header-title ti-mt-2"><?php
/* translators: %s: Airbnb reviews */
echo esc_html(sprintf(__('Check some %s widget layouts and styles', 'review-widgets-for-airbnb'), 'Airbnb reviews'));
?></h1>
<?php include(plugin_dir_path(__FILE__) . '../include/demo-widgets.php'); ?>
<?php elseif ($stepCurrent === 2): ?>
<h1 class="ti-header-title"><?php echo esc_html(__('Select Layout', 'review-widgets-for-airbnb')); ?></h1>
<?php if (!count($reviews) && !$isReviewDownloadInProgress): ?>
<div class="ti-notice ti-notice-warning" style="margin: 0 0 15px 0">
<p>
<?php
/* translators: %s: Airbnb */
echo esc_html(sprintf(__('There are no reviews on your %s platform.', 'review-widgets-for-airbnb'), 'Airbnb'));
?>
</p>
</div>
<?php endif; ?>
<div class="ti-box ti-box-filter">
<label><?php echo esc_html(__('Layout', 'review-widgets-for-airbnb')); ?>:</label>
<span class="ti-checkbox">
<input type="radio" name="layout-select" value="" data-ids="" checked>
<label><?php echo esc_html(__('All', 'review-widgets-for-airbnb')); ?></label>
</span>
...
switch ($category) {
case 'slider':
echo esc_html(__('Slider', 'review-widgets-for-airbnb'));
break;
case 'sidebar':
echo esc_html(__('Sidebar', 'review-widgets-for-airbnb'));
break;
case 'list':
echo esc_html(__('List', 'review-widgets-for-airbnb'));
break;
case 'grid':
echo esc_html(__('Grid', 'review-widgets-for-airbnb'));
break;
case 'Badge':
echo esc_html(__('Badge', 'review-widgets-for-airbnb'));
break;
case 'Button':
echo esc_html(__('Button', 'review-widgets-for-airbnb'));
break;
case 'floating':
echo esc_html(__('Floating', 'review-widgets-for-airbnb'));
break;
case 'popup':
echo esc_html(__('Popup', 'review-widgets-for-airbnb'));
break;
case 'top-rated-badge':
echo esc_html(__('Top Rated Badge', 'review-widgets-for-airbnb'));
break;
case 'fomo':
echo esc_html(__('Fomo', 'review-widgets-for-airbnb'));
break;
default:
...
<?php echo esc_html(__('Layout', 'review-widgets-for-airbnb')); ?>:
<strong><?php echo esc_html($template['name']); ?></strong>
<?php if ($template['is-popular'] || 14 === $id): ?>
<span class="ti-badge ti-most-popular-badge ti-tooltip">
<?php echo esc_html(__('Most popular', 'review-widgets-for-airbnb')); ?> <span class="dashicons dashicons-info-outline"></span>
<span class="ti-tooltip-message"><?php echo
esc_html(__('Selected by most users!', 'review-widgets-for-airbnb')).' '.
esc_html(__('This widget layout helps build trust and effectively increases sales.', 'review-widgets-for-airbnb'));
?></span>
</span>
<?php endif; ?>
<?php if (14 === $id) :?>
<a href="#" class="ti-btn ti-btn-sm ti-pull-right" style="pointer-events: none;background: grey">
<?php echo esc_html(__('Paid package feature', 'review-widgets-for-airbnb')); ?>
</a>
<?php elseif ((!$template['is-top-rated-badge'] || $isTopRatedBadgeValid) && !$fomoWidgetInvalid): ?>
<a href="<?php echo esc_url(wp_nonce_url('?page='. esc_attr($_page) .'&tab=free-widget-configurator&command=save-style&style_id='. esc_attr(urlencode($id)), 'ti-save-style')); ?>" class="ti-btn ti-btn-sm ti-btn-loading-on-click ti-pull-right"><?php echo esc_html(__('Select', 'review-widgets-for-airbnb')); ?></a>
<div class="clear"></div>
<?php endif; ?>
</div>
<div class="preview">
...
echo esc_html(sprintf(__('Our exclusive "Top Rated" badge is awarded to service providers with a rating of %s and above.', 'review-widgets-for-airbnb'), $pluginManager::$topRatedMinimumScore));
?><br />
</p>
</div>
<?php endif; ?>
...
<div class="ti-notice ti-notice-info" style="margin: 0 0 15px 0">
<p>
<?php echo esc_html(__('Update your reviews to use this widget.', 'review-widgets-for-airbnb')); ?><br />
</p>
</div>
<?php endif; ?>
...
<h1 class="ti-header-title"><?php echo esc_html(__('Select Style', 'review-widgets-for-airbnb')); ?></h1>
<?php if (!count($reviews) && !$isReviewDownloadInProgress): ?>
<div class="ti-notice ti-notice-warning" style="margin: 0 0 15px 0">
<p>
<?php
...
<div class="ti-box-inner">
<div class="ti-box-header ti-box-header-normal">
<?php echo esc_html(__('Style', 'review-widgets-for-airbnb')); ?>:
...
<span class="ti-tooltip-message"><?php echo
esc_html(__('Selected by most users!', 'review-widgets-for-airbnb')).' '.
esc_html(__('This widget style helps build trust and effectively increases sales.', 'review-widgets-for-airbnb'));
?></span>
</span>
<?php endif; ?>
<a href="<?php echo esc_url(wp_nonce_url('?page='. esc_attr($_page) .'&tab=free-widget-configurator&command=save-set&set_id='. esc_attr(urlencode($id)), 'ti-save-set')); ?>" class="ti-btn ti-btn-sm ti-btn-loading-on-click ti-pull-right"><?php echo esc_html(__('Select', 'review-widgets-for-airbnb')); ?></a>
<div class="clear"></div>
</div>
<div class="preview">
...
-
<?php echo esc_html(__('with Trustindex verified', 'review-widgets-for-airbnb')); ?>
</strong>
...
<a href="<?php echo esc_url(wp_nonce_url('?page='. esc_attr($_page) .'&tab=free-widget-configurator&command=save-set&set_id='. esc_attr(urlencode($id)), 'ti-save-set')); ?>&verified_by_trustindex" class="ti-btn ti-btn-sm ti-btn-loading-on-click ti-pull-right"><?php echo esc_html(__('Select', 'review-widgets-for-airbnb')); ?></a>
<div class="clear"></div>
</div>
<div class="preview">
...
<p>
<span class="dashicons dashicons-star-empty"></span> <strong><?php echo esc_html(__('Congratulations!', 'review-widgets-for-airbnb')); ?></strong><br />
<?php
/* translators: 1: 5, 2: 4.5, 3: 12 */
echo esc_html(sprintf(__('Our system ranked you in the top %1$d%% of companies based on your reviews. Your total rating score above %2$s in the last %3$d month, and your reviews are genuine', 'review-widgets-for-airbnb'), 5, $pluginManager::$topRatedMinimumScore, 12));
?><br />
<?php echo wp_kses_post(__('This allows you to <strong>use in the widgets the Trustindex verified badge, the Universal Symbol of Trust.</strong> With the verified badge you can build more trust, and sell more!', 'review-widgets-for-airbnb')); ?>
</p>
</div>
</div>
</div>
...
<h1 class="ti-header-title"><?php echo esc_html(__('Set up widget', 'review-widgets-for-airbnb')); ?></h1>
<?php if (!count($reviews) && !$isReviewDownloadInProgress): ?>
<div class="ti-notice ti-notice-warning" style="margin: 0 0 15px 0">
<p>
<?php
...
echo esc_html(sprintf(__('Our exclusive "Top Rated" badge is awarded to service providers with a rating of %s and above.', 'review-widgets-for-airbnb'), $pluginManager::$topRatedMinimumScore));
?><br />
<a href="?page=<?php echo esc_attr($_page); ?>&tab=free-widget-configurator&step=2" class="ti-btn ti-btn-sm ti-btn-loading-on-click" style="margin-top: 10px"><?php echo esc_html(__('Please select another widget', 'review-widgets-for-airbnb')); ?></a>
</p>
</div>
<?php endif; ?>
<div class="ti-preview-boxes-container">
...
<?php echo esc_html(__('Widget Preview', 'review-widgets-for-airbnb')); ?>
...
<div class="ti-box">
<div class="ti-box-inner">
<div class="ti-box-header"><?php echo esc_html(__('Widget Settings', 'review-widgets-for-airbnb')); ?></div>
...
<label>
<?php echo esc_html(__('Verified by Trustindex', 'review-widgets-for-airbnb')); ?>
<span class="ti-badge ti-badge-info"><?php echo esc_html(__('Recommended', 'review-widgets-for-airbnb')); ?></span>
</label>
...
<option value="0"<?php if (!$verifiedByTrustindex): ?> selected<?php endif; ?>><?php echo esc_html(__('Hide', 'review-widgets-for-airbnb')); ?></option>
<option value="1"<?php if ($verifiedByTrustindex === 1): ?> selected<?php endif; ?>><?php echo
/* translators: %d: 1 */
esc_html(sprintf(__('Style %d', 'review-widgets-for-airbnb'), 1));
?></option>
<option value="2"<?php if ($verifiedByTrustindex === 2): ?> selected<?php endif; ?>><?php
/* translators: %d: 2 */
echo esc_html(sprintf(__('Style %d', 'review-widgets-for-airbnb'), 2));
?></option>
</select>
</form>
</div>
...
<div class="ti-form-group">
<label><?php echo esc_html(__('Filter your ratings', 'review-widgets-for-airbnb')); ?></label>
...
<option value="1,2,3,4,5"<?php if (count($filter['stars']) > 2): ?> selected<?php endif; ?>><?php echo esc_html(__('Show all', 'review-widgets-for-airbnb')); ?></option>
...
<option value="5"<?php if (count($filter['stars']) === 1): ?> selected<?php endif; ?>><?php echo esc_html(__('only', 'review-widgets-for-airbnb')); ?> &starf;&starf;&starf;&starf;&starf;</option>
</select>
</form>
</div>
<?php endif; ?>
<div class="ti-form-group">
<label><?php echo esc_html(__('Select language', 'review-widgets-for-airbnb')); ?></label>
<form method="post" action="">
...
<?php if ($pluginManagerInstance->isLayoutHasReviews()): ?>
<div class="ti-form-group">
<label><?php echo esc_html(__('Select date format', 'review-widgets-for-airbnb')); ?></label>
<form method="post" action="">
...
break;
case 'hide':
echo esc_html(__('Hide', 'review-widgets-for-airbnb'));
break;
default:
...
<div class="ti-form-group">
<label><?php echo esc_html(__('Select name format', 'review-widgets-for-airbnb')); ?></label>
<form method="post" action="">
...
<?php
if (1 === (int)$format['id']) {
echo esc_html(__('Do not format', 'review-widgets-for-airbnb'));
} else {
...
<?php if (!in_array($styleId, [17, 21, 52, 53, 112, 114])): ?>
<div class="ti-form-group">
<label><?php echo esc_html(__('Align', 'review-widgets-for-airbnb')); ?></label>
<form method="post" action="">
<input type="hidden" name="command" value="save-align" />
<?php wp_nonce_field('ti-save-align'); ?>
<select class="ti-form-control" name="align">
<option value="left" <?php echo $pluginManagerInstance->getWidgetOption('align') === 'left' ? 'selected' : ''; ?>><?php echo esc_html(__('left', 'review-widgets-for-airbnb')); ?></option>
<option value="center" <?php echo $pluginManagerInstance->getWidgetOption('align') === 'center' ? 'selected' : ''; ?>><?php echo esc_html(__('center', 'review-widgets-for-airbnb')); ?></option>
<option value="right" <?php echo $pluginManagerInstance->getWidgetOption('align') === 'right' ? 'selected' : ''; ?>><?php echo esc_html(__('right', 'review-widgets-for-airbnb')); ?></option>
<option value="justify" <?php echo $pluginManagerInstance->getWidgetOption('align') === 'justify' ? 'selected' : ''; ?>><?php echo esc_html(__('justify', 'review-widgets-for-airbnb')); ?></option>
</select>
</form>
</div>
<div class="ti-form-group">
<label><?php echo esc_html(__('Review text', 'review-widgets-for-airbnb')); ?></label>
<form method="post" action="">
...
<option value="scroll" <?php echo $pluginManagerInstance->getWidgetOption('review-text-mode') === 'scroll' ? 'selected' : ''; ?>><?php echo esc_html(__('Scroll', 'review-widgets-for-airbnb')); ?></option>
<option value="readmore" <?php echo $pluginManagerInstance->getWidgetOption('review-text-mode') === 'readmore' ? 'selected' : ''; ?>><?php echo esc_html(__('Read more', 'review-widgets-for-airbnb')); ?></option>
<option value="truncated" <?php echo $pluginManagerInstance->getWidgetOption('review-text-mode') === 'truncated' ? 'selected' : ''; ?>><?php echo esc_html(__('Truncated', 'review-widgets-for-airbnb')); ?></option>
</select>
</form>
</div>
<?php endif; ?>
...
<div class="ti-form-group">
<label><?php echo esc_html(__('Select type', 'review-widgets-for-airbnb')); ?></label>
<form method="post" action="">
...
switch ($type) {
case 'Apartment':
echo esc_html(__('Apartment', 'review-widgets-for-airbnb'));
break;
case 'Bar':
echo esc_html(__('Bar', 'review-widgets-for-airbnb'));
break;
case 'Cafe':
echo esc_html(__('Cafe', 'review-widgets-for-airbnb'));
break;
case 'Clinic':
echo esc_html(__('Clinic', 'review-widgets-for-airbnb'));
break;
case 'Hotel':
echo esc_html(__('Hotel', 'review-widgets-for-airbnb'));
break;
case 'Provider':
echo esc_html(__('Provider', 'review-widgets-for-airbnb'));
break;
case 'Restaurant':
echo esc_html(__('Restaurant', 'review-widgets-for-airbnb'));
break;
case 'Service':
echo esc_html(__('Service', 'review-widgets-for-airbnb'));
break;
case 'Webshop':
echo esc_html(__('Webshop', 'review-widgets-for-airbnb'));
break;
default:
echo esc_html($type);
break;
...
<option value="hide"<?php if ($topRatedDate === 'hide'): ?> selected<?php endif; ?>><?php echo esc_html(__("Hide", 'review-widgets-for-airbnb')); ?></option>
<option value="last-year"<?php if ($topRatedDate === 'last-year'): ?> selected<?php endif; ?>><?php echo esc_html(__("Last year", 'review-widgets-for-airbnb')); ?></option>
<option value=""<?php if (!$topRatedDate): ?> selected<?php endif; ?>><?php echo esc_html(__("Current year", 'review-widgets-for-airbnb')); ?></option>
</select>
</form>
</div>
<?php endif; ?>
...
<label><?php echo esc_html(__('Title', 'review-widgets-for-airbnb')); ?></label>
<form method="post" action="">
...
<small class="ti-text-muted" style="padding-left: 5px"><?php echo esc_html(htmlentities(__('Enclose the text in <u></u> if you want to highlight it', 'review-widgets-for-airbnb'))); ?></small>
</form>
</div>
<div class="ti-form-group" style="max-width: 400px">
<label><?php echo esc_html(__('Subtitle', 'review-widgets-for-airbnb')); ?></label>
<form method="post" action="">
...
<option value="hide" <?php echo $pluginManagerInstance->getWidgetOption('fomo-text') === '' ? 'selected' : ''; ?>><?php echo esc_html(__('Hide', 'review-widgets-for-airbnb')); ?></option>
...
<div class="ti-form-group">
<label><?php echo esc_html(__('Icon', 'review-widgets-for-airbnb')); ?></label>
<form method="post" action="">
...
<option value="hide" <?php echo $pluginManagerInstance->getWidgetOption('fomo-icon') === 'hide' ? 'selected' : ''; ?>><?php echo esc_html(__('Hide', 'review-widgets-for-airbnb')); ?></option>
...
switch ($icon) {
case 'profile-images':
echo esc_html(__('Profile images', 'review-widgets-for-airbnb'));
break;
case 'platform':
echo esc_html(__('Platform', 'review-widgets-for-airbnb'));
break;
default:
...
<div class="ti-form-group">
<label><?php echo esc_html(__('Color', 'review-widgets-for-airbnb')); ?></label>
<form method="post" action="">
...
<div class="ti-form-group">
<label><?php echo esc_html(__('Margin', 'review-widgets-for-airbnb')); ?></label>
<form method="post" action="">
...
<div class="ti-form-group">
<label><?php echo esc_html(__('Number of days', 'review-widgets-for-airbnb')); ?></label>
<form method="post" action="">
...
$name = sprintf(__('%d days', 'review-widgets-for-airbnb'), $day);
if ($day === 1) {
/* translators: %d: 24 */
$name = sprintf(__('%d hours', 'review-widgets-for-airbnb'), 24);
}
?>
...
<div class="ti-form-group">
<label><?php echo esc_html(__('Hide until count reaches', 'review-widgets-for-airbnb')); ?></label>
<form method="post" action="">
...
<label><?php echo esc_html(__('Hide reviews without comments', 'review-widgets-for-airbnb')); ?></label>
</span>
<?php endif; ?>
...
<label><?php echo esc_html(__('Hide rating text', 'review-widgets-for-airbnb')); ?></label>
</span>
<?php endif; ?>
...
<label><?php echo esc_html(__('Show minimum review filter condition', 'review-widgets-for-airbnb')); ?></label>
</span>
<?php endif; ?>
<?php if ($pluginManagerInstance->isLayoutHasReviews()): ?>
<span class="ti-checkbox ti-checkbox-row">
...
<label><?php echo esc_html(__('Show review reply', 'review-widgets-for-airbnb')); ?></label>
</span>
<?php endif; ?>
...
<label><?php echo esc_html(__('Show write review button', 'review-widgets-for-airbnb')); ?></label>
</span>
<?php endif; ?>
...
<label><?php echo esc_html(__('Show "Load more" button', 'review-widgets-for-airbnb')); ?></label>
</span>
<?php endif; ?>
...
<label><?php echo esc_html(__('Show verified review icon', 'review-widgets-for-airbnb')); ?></label>
</span>
<?php endif; ?>
...
<label><?php echo esc_html(__('Show navigation arrows', 'review-widgets-for-airbnb')); ?></label>
</span>
<?php endif; ?>
...
<label><?php echo esc_html(__("Show reviewer's profile picture", 'review-widgets-for-airbnb')); ?></label>
</span>
<span class="ti-checkbox ti-checkbox-row ti-disabled">
<input type="checkbox" value="1" disabled />
<label class="ti-tooltip">
<?php echo esc_html(__("Show reviewer's profile picture locally, from a single image (less requests)", 'review-widgets-for-airbnb')); ?>
<span class="ti-tooltip-message"><?php echo esc_html(__('Paid package feature', 'review-widgets-for-airbnb')); ?></span>
</label>
</span>
<span class="ti-checkbox ti-checkbox-row ti-disabled">
<input type="checkbox" value="1" disabled />
<label class="ti-tooltip">
<?php echo esc_html(__('Show photos in reviews', 'review-widgets-for-airbnb')); ?>
<span class="ti-tooltip-message"><?php echo esc_html(__('Paid package feature', 'review-widgets-for-airbnb')); ?></span>
</label>
</span>
<?php endif; ?>
...
<label><?php echo esc_html(__('Enable mouseover animation', 'review-widgets-for-airbnb')); ?></label>
</span>
<?php endif; ?>
<?php if (!$pluginManagerInstance->isFomoWidget()): ?>
<span class="ti-checkbox ti-checkbox-row">
...
<label><?php echo esc_html(__("Use site's font", 'review-widgets-for-airbnb')); ?></label>
</span>
<?php endif; ?>
<?php if ($pluginManagerInstance->isLayoutHasReviews()): ?>
<span class="ti-checkbox ti-checkbox-row">
<input type="checkbox" name="show-logos" value="1"<?php if ($pluginManagerInstance->getWidgetOption('show-logos')): ?> checked<?php endif;?> />
<label><?php echo esc_html(__('Show platform logos', 'review-widgets-for-airbnb')); ?></label>
</span>
...
<label><?php echo esc_html(__('Show platform stars', 'review-widgets-for-airbnb')); ?></label>
</span>
<?php endif; ?>
<?php endif; ?>
<?php if ($pluginManagerInstance->isFomoWidget()): ?>
...
<label><?php echo esc_html(__('Default open', 'review-widgets-for-airbnb')); ?></label>
</span>
<?php endif; ?>
<span class="ti-checkbox ti-checkbox-row">
<input type="checkbox" name="fomo-border" value="1"<?php if ($pluginManagerInstance->getWidgetOption('fomo-border')): ?> checked<?php endif; ?> />
<label><?php echo esc_html(__('Show border', 'review-widgets-for-airbnb')); ?></label>
</span>
...
<label><?php echo esc_html(__('Show icon background', 'review-widgets-for-airbnb')); ?></label>
</span>
<?php endif; ?>
<span class="ti-checkbox ti-checkbox-row">
<input type="checkbox" name="fomo-link" value="1"<?php if ($pluginManagerInstance->getWidgetOption('fomo-link')): ?> checked<?php endif; ?> />
<label><?php echo esc_html(__('Enable link', 'review-widgets-for-airbnb')); ?></label>
</span>
...
<label><?php echo esc_html(__('Show arrow', 'review-widgets-for-airbnb')); ?></label>
</span>
<?php endif; ?>
<?php endif; ?>
</form>
...
<a href="<?php echo esc_url(wp_nonce_url('?page='. esc_attr($_page) .'&tab=free-widget-configurator&setup_widget', 'ti-setup-widget')); ?>" class="ti-btn ti-btn-loading-on-click ti-pull-right"><?php echo esc_html(__('Save and get code', 'review-widgets-for-airbnb')); ?></a>
<div class="clear"></div>
</div>
<?php endif; ?>
</div>
...
<?php else: ?>
<h1 class="ti-header-title"><?php echo esc_html(__('Insert code', 'review-widgets-for-airbnb')); ?></h1>
<?php if (!count($reviews) && !$isReviewDownloadInProgress): ?>
<div class="ti-notice ti-notice-warning" style="margin: 0 0 15px 0">
<p>
<?php
...
<?php endif; ?>
<div class="ti-box">
<div class="ti-box-header"><?php echo esc_html(__('Insert this shortcode into your website', 'review-widgets-for-airbnb')); ?></div>
