...
$chosedPlatform = new $className($forcePlatform, $filePath, "do-not-care-12.4.5", "do-not-care-Widgets for Airbnb Reviews", "do-not-care-Airbnb");
...
$preContent = str_replace(['src="', 'srcset="'], ['data-ti-src="', 'data-ti-srcset="'], $preContent);
